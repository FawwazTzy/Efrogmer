...
import NotifIcon from "../../../modes/Fawwaz.Allrightreserved/Frognotif.png"; // ⬅️ Import gambar kamu

const WG_Notification3 = ({ show, fromRight = true, text }) => {
...
export default WG_Notification3;
