...
const WG_WordBubble3 = ({ wordData, style = {}, onDragStart, isDragging }) => {
  ...
  return (
    <div
      ...
      className={`absolute select-none
        ...
        bg-[url('https://i.pinimg.com/1200x/b7/31/2f/b7312fe48234c3553365df894442135b.jpg')]
