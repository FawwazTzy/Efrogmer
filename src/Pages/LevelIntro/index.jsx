  ...
  return (
    <div className="relative min-h-screen text-gray-50 overflow-hidden flex items-center justify-center px-3 py-4">
      ...
      <div className="relative w-full max-w-5xl flex flex-col md:flex-row gap-4 md:gap-6 justify-center">
        ...
        {/* 🟦 PANEL KIRI */}
        <div className="w-[95px] sm:w-[110px] md:w-32
          ...
          {/* Illust */}
          <div className="mt-4 w-20 h-28 sm:w-24 sm:h-36 rounded-lg 
        ...
        <div className="flex-1 p-4 sm:p-6 rounded-xl 
          ...
          <div className="mt-4">
            ...
            <div className="w-full font-poppins bg-black/50 border border-white/15
              px-3 py-2 rounded-md space-y-1.5 text-xs sm:text-sm text-gray-200">

              <p><span className="font-semibold text-yellow-300">Definition:</span> {level.definition}</p>
              <p><span className="font-semibold text-yellow-300">Example:</span> {level.example}</p>
              <p><span className="font-semibold text-yellow-300">Function:</span> {level.function}</p>
            </div>
          </div>
